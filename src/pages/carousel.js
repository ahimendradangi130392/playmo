    ...
    >
        ...
        <div className="carousel-item" >
                ...
                <div className="adventure thought thought-3">
                        ...
                        <div className="thought-text">
                                <h5>Vartika</h5>
                                <h6> mom of Krisha, 5</h6>
                        <p><span class="fa fa-quote-left"></span>Lovely initiative by playmo! Kids had so much fun : <span class="fa fa-quote-right"></span>
                        </p>
                        </div>
                </div>
                <div className="adventure thought thought-4 ">
                        ...
                        <div className="thought-text">
                                <h5>Soumali</h5>
                                <h6>Mom of Renesa & Rhythm, 3 and 1</h6>
                                <p><span class="fa fa-quote-left"></span>Renesa enjoyed so much! The best part is that it is as per our schedules and at a convenient location near us. Thanks a lot, and we will come every week!<span class="fa fa-quote-right"></span></p>
                        </div>
                </div>
        </div>            
        </div>
            ...
            <div className="carousel-item" >
                ...
                <div className="adventure thought thought-3">
                        ...
                        <div className="thought-text">
                                <h5>Devjani M</h5>
                                <h6> mom of Krisha, 5</h6>
                                <p><span class="fa fa-quote-left"></span>Such a new concept - definitely the need of the hour<span class="fa fa-quote-right"></span></p>
                        </div>
                </div>  
                <div className="adventure thought thought-2">
                        ...
                        <div className="thought-text">
                                <h5>Rashmi S</h5>
                                <h6>Momof Viniya, 3 yrs old</h6>
                        <p><span class="fa fa-quote-left"></span>Viniya had a lot of fun! This is such a great initiative - already recommended this to my daughter's friends and look forward to getting her for the next one!<span class="fa fa-quote-right"></span>
                        </p>
                        </div>
                </div>
